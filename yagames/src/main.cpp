...
extern "C"
{
    ...
    const char* YaGamesPrivate_Player_GetPersonalInfo();
...
static int Player_GetPayingStatus(lua_State* L)
{
    const char* str = YaGamesPrivate_Player_GetPayingStatus();
    if (str) {
...
static int Player_GetPersonalInfo(lua_State* L)
{
    const char* str = YaGamesPrivate_Player_GetPersonalInfo();
    if (str) {
        lua_pushstring(L, str);
        free((void*)str);
    } else {
...
static int Player_GetMode(lua_State* L)
{
    const char* mode = YaGamesPrivate_Player_GetMode();
...
static const luaL_reg Module_methods[] = {
    ...
    { "player_get_paying_status", Player_GetPayingStatus },
    { "player_get_personal_info", Player_GetPersonalInfo },
